...
// This file demonstrates basic process management and context switching between
// processes
...
// SBI (Supervisor Binary Interface) provides a way for the OS to interact with
// the machine
...
struct process *create_process(uint32_t pc) {
  ...
  uint32_t *sp = (uint32_t *)&proc
                     ->stack[sizeof(proc->stack)]; // Start at the top of stack
